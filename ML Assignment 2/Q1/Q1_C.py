...
def main():
    ...
    for idxP in range(1,11):
        ...
        for idxd in range(0,7):
            ...
            List_Prediction = []
            List_Actual_Value = []
            for Temp_Value in  Portfolio_1_Information:
        ...
        # getting data in vars
        Temp_X_Data = [Temp_Value[0] for Temp_Value in  Portfolio_1_Information]
        ...
        # plotting graphs with above vars
        ...
        plt.title("Value of K is "+str(idxP))
        plt.legend()
        plt.show()
    print('END Q1_C\n')
