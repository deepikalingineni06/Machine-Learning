...
def main():
    ...
    # load data 
    X_Train = np.array([Temp_X_Value[0] for Temp_X_Value in Portfolio_1_Information])
    Y_Train = np.array([Temp_X_Value[1] for Temp_X_Value in Portfolio_1_Information])
