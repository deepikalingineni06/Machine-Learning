...
def main():
    ...
    for Token in range(len(Portfolio_3_Information)):
        ...
        List_of_Features.append([Temp_Data[0], Temp_Data[1], Temp_Data[2]])
    List_of_Labels = []
    for Token in range(len(Portfolio_3_Information)):
        Temp_Data = Portfolio_3_Information[Token]
    ...
    Logistic_pred = Trained_Model_Instance.Predict_method(List_of_Features)
    Logistic_Acc = (Logistic_pred == List_of_Labels).mean() * 100
    Logistic_Acc = round(Logistic_Acc, 2)
    print("Model")
    print("Input - Height, Weight and Age")
    print("Accuracy -",Logistic_Acc)

    # run one vs all approach
    Logistic_Acc = Leave_One_Out(List_of_Features, List_of_Labels)
    Logistic_Acc = round(Logistic_Acc, 2)
    print("Leave One Out ")
    print("Input - Height, Weight and Age")
    print("Accuracy -",Logistic_Acc)
